...
<div class="block-cases">
	<div class="cases-list">
		...
		<?php 
		$wp_query = new WP_Query(array('post_type' => 'case', 'tax_query' => array(array('taxonomy' => 'case_tag', 'field' => 'id',	'terms' => get_queried_object_id())), 'posts_per_page' => $posts_per_page, 'paged' => get_query_var('paged')));
